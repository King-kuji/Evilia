...
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:KING KUJI\n' 
            + 'ORG:Creador De EvilBOT-V72\n' 
            + 'TEL;type=CELL;type=VOICE;waid=16509667946:+1 (650) 966-7946\n' 
            + 'END:VCARD'
//WhatsApp Conexión
const
	{
...
async function starts() {
	...
	console.log(color('[ BOT]','aqua'), color("BOT BY Kuji", "yellow"))
	console.log('>', '[',color('INFO','blue'),']','Suscribete A Kuji inc.')
	FxBot.on('qr', () => {
...
┠⊷️*ൠ💣  ｈｔ𝐓Ƥ://Ⓦα.Μᗴ/❶❻５Ѳ９➅６➆❾❹❻  ♖♠
┠⊷️ *Grupo Oficial*:
┠⊷️ *ㄥƆᗡſƐㄣ6ɾWſſ∩lɯގΌ∩0H˥Sᗡ/ɯoɔ˙ddɐsʇɐɥʍ˙ʇɐɥɔ//:sdʇʇɥ
┗━━━━━━━━━━━━━━━━━
┏━━━━━━━━━━━━━━━━━
┠⊷️「 *DESCRIPCIÓN* 」
┗━━━━━━━━━━━━━━━━━
...
.then((a) => {
if (Number(filesize) >= 30000) return sendMediaURL(from, thumb, `*DESCARGADOR DE AUDIO BY King Kuji-in*\n\n*🤓Titulo*: ${title}\n*⏭️Extensión*:MP3\n*⚖️Tamaño*:${filesizeF}\n*Link* : ${a.data}\n\n_Para la duración de más del límite se presenta en forma de enlace_`)
const captions = `*DESCARGADOR DE AUDIO BY King Kuji-in*\n\n*🤓Titulo*: ${title}\n*⏭️Extensión*:MP3\n*⚖️Tamaño*:${filesizeF}\n\n_ESPERE ENVIANDO ARCHIVO, NO SPAMES LA CONCHA DE TU MADRE_`
...
reply(mess.mpv)
				...
				axios.get(`https://tinyurl.com/api-create.php?url=${dl_link}`)
				.then((a) => {
				if (Number(filesize) >= 40000) return sendMediaURL(from, thumb, `*DESCARGADOR DE VIDEO BY King Kuji-in*\n\n*🤓Titulo*: ${title}\n*⏭️Extensión*:MP3\n*File⚖️Tamaño*:${filesizeF}\n*Link* : ${a.data}\n\n_Para la duración de más del límite se presenta en forma de enlace_`)
...
case prefix+ 'play':
   			...
   			var mulaikah = aramat[0].url							
                  try {
                    ...
                    .then((res) => {
                        ...
                        axios.get(`https://tinyurl.com/api-create.php?url=${dl_link}`)
                        .then(async (a) => {
                        if (Number(filesize) >= 100000) return sendMediaURL(from, thumb, `*DESCARGADOR DE MUSICA BY King Kuji-in*\n\n*🤓Titulo*: ${title}\n*⏭️Extensión*: MP3\n*⚖️Tamaño*: ${filesizeF}\n*📎Link* : ${a.data}\n\n_ESPERE ENVIANDO ARCHIVO, NO SPAMES  rassomware_`)
		                        const captions = `*DESCARGADOR DE MUSICA BY King Kuji-in*\n\n*🤓Titulo*: ${title}\n*⏭️Extensión*: MP3\n*⚖️Tamaño*: ${filesizeF}\n*📎Link*: ${a.data}\n\n_ESPERE ENVIANDO ARCHIVO, NO SPAMES oh activo rassomware_`
                        sendMediaURL(from, thumb, captions)
         ...
         //------FUNCIONES PARA EL USUÁRIO-------
                   ...
                   FxBot.updatePresence(from, Presence.composing) 
      options = {
          text: `「 *LINK WHATSAPP* 」\n\n_Solicitado por_ : *@${sender.split("@s.whatsapp.net")[0]}\n\nSu link de Whatsapp : *https://wa.me/+16509667946${sender.split("@s.whatsapp.net")[0]}*\n*O ( / )*\n*https://api.whatsapp.com/send?phone=${sender.split("@")[0]}*`,
          contextInfo: { mentionedJid: [sender] }
    }
    FxBot.sendMessage(from, options, text, { quoted: mek } )
				break
case prefix+ 'creador':
await FxBot.sendMessage(from, {displayname: "King Kuji-in🧙‍♂️", vcard: vcard}, MessageType.contact)
break
